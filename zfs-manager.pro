...
dotrans.path=/usr/local/share/zfs-manager/i18n/
dotrans.extra=cd i18n && $${LRELEASE} -nounfinished *.ts && cp *.qm $(INSTALL_ROOT)/usr/local/share/zfs-manager/i18n/

icons.path=/usr/local/share/pixmaps
icons.files=icons/diskmanager.png

desktop.files=zfs-manager.desktop
